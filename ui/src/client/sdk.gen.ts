 ...
 */
export const deleteWorkflowEndpointApiV1WorkflowWorkflowIdDelete = <ThrowOnError extends boolean = false>(options: Options<DeleteWorkflowEndpointApiV1WorkflowWorkflowIdDeleteData, ThrowOnError>) => (options.client ?? client).delete<DeleteWorkflowEndpointApiV1WorkflowWorkflowIdDeleteResponses, DeleteWorkflowEndpointApiV1WorkflowWorkflowIdDeleteErrors, ThrowOnError>({ url: '/api/v1/workflow/{workflow_id}', ...options });
