...
SPECS_JSON="$(mktemp -t noral-specs-XXXXXX.json)"
OPENAPI_JSON="$(mktemp -t noral-openapi-XXXXXX.json)"
...
PYTHONPATH="$REPO_ROOT/sdk/python/src" python -m noral_sdk.codegen \
    --input "$SPECS_JSON" \
    --out "sdk/python/src/noral_sdk/typed"
...
datamodel-codegen \
    ...
    --output "sdk/python/src/noral_sdk/_generated_models.py" \
...
python -m sdk.codegen.client_codegen \
    --input "$OPENAPI_JSON" \
    --py-out "sdk/python/src/noral_sdk/_generated_client.py" \
