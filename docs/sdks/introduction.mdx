...
- **Python** — [`noralai-voice`](https://pypi.org/project/noralai-voice/) on PyPI
- **TypeScript** — [`@noralai/voice-sdk`](https://www.npmjs.com/package/@noralai/voice-sdk) on npm
...
<CodeGroup>
```python Python
from noralai_voice import DograhClient
