> **SUPERSEDED — 2026-08-08.** This is v1 of the control-plane brief, kept for provenance.
> The active plan is [control-plane-build-plan.md](./control-plane-build-plan.md) (v2), which
> reorders the destructive phase, maps onto existing tables, and closes the vendor decision.
